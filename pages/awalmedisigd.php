...
// Handle DELETE request - via AJAX di awalmedisigd.js (hapusData -> proses3.php)
...
// Cek apakah sudah ada data penilaian medis IGD dengan info dokter
...
if($isEdit) {
    ...
    // Jika tambah baru, cek apakah ada data triase untuk auto-fill TTV
    $queryTriase = bukaquery("SELECT 
                                tekanan_darah,
                                nadi,
                                pernapasan,
                                suhu,
    ...
    $rsTriase = mysqli_fetch_array($queryTriase);

    // Auto-fill TTV dari triase jika ada
    if($rsTriase) {
        $data['td'] = $rsTriase['tekanan_darah'] ?? '';
        $data['nadi'] = $rsTriase['nadi'] ?? '';
        $data['rr'] = $rsTriase['pernapasan'] ?? '';
        $data['suhu'] = $rsTriase['suhu'] ?? '';
        $data['spo'] = $rsTriase['saturasi_o2'] ?? '';
    }
}
?>
...
<div class="modern-form-container">
    ...
    <div class="form-card">
        <div class="form-content">
            <form id="formPenilaianMedisIGD" method="post" action="">
                ...
                <div class="section">
                    ...
                    <div class="status-grid">
                        ...
                        <div class="status-item">
                            <label>Leher</label>
                            <select name="leher">
                                <option value="Normal" <?php echo ($data['leher'] == 'Normal') ? 'selected' : ''; ?>>Normal</option>
                                <option value="Abnormal" <?php echo ($data['leher'] == 'Abnormal') ? 'selected' : ''; ?>>Abnormal</option>
                                <option value="Tidak Diperiksa" <?php echo ($data['leher'] == 'Tidak Diperiksa') ? 'selected' : ''; ?>>Tidak Diperiksa</option>
                            </select>
                        </div>
                        <div class="status-item">
                            <label>Thoraks</label>
                    ...
                    <div class="form-grid cols-3">
                        <div class="form-group">
                            ...
                            <textarea name="ekg" rows="4" 
                                      placeholder="Hasil pemeriksaan EKG..."><?php echo $data['ekg']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Hasil Radiologi</label>
                            <textarea name="rad" rows="4" 
                                      placeholder="Hasil Rontgen, CT Scan, dll..."><?php echo $data['rad']; ?></textarea>
                        </div>
                        <div class="form-group">
        ...
        <div class="action-bar">
            <button type="button" class="btn btn-secondary" onclick="kembaliAwalMedisIGD()">
            ...
            if($bolehHapus): 
            ?>
            <button type="button" id="btn-delete-igd" class="btn btn-danger" onclick="confirmDeleteIGD()">
            ...
            <?php endif; ?>
            <button type="submit" id="btn-save-igd" form="formPenilaianMedisIGD" class="btn btn-primary">
...
<!-- Delete via AJAX - handled by awalmedisigd.js -->

<script src="<?php echo BASE_URL; ?>/js/awalmedisigd.js?v=<?php echo time(); ?>"></script>
<script src="<?php echo BASE_URL; ?>/js/field-indicator-igd.js?v=<?php echo time(); ?>"></script>