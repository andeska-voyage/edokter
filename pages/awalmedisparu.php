...
// Cek apakah sudah ada data penilaian medis Paru
$queryCheck = bukaquery("SELECT pmr.*, d.nm_dokter as nama_dokter_pengisi 
                         FROM penilaian_medis_ralan_paru pmr
...
// Data default sesuai tabel penilaian_medis_ralan_paru
$data = array(
...
<div class="modern-form-container">
    ...
    <div class="patient-header">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
            <h1 style="margin: 0; display: flex; align-items: center; gap: 10px;">
                ...
                PENILAIAN AWAL MEDIS RAWAT JALAN PARU
                <?php if($isEdit): ?>
            ...
            <div style="display: flex; align-items: center; gap: 10px; background: #f8f9fa; border-radius: 8px; padding: 8px 12px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 2px;">
                    <div style="display: flex; align-items: center; gap: 5px;">
                        ...
                        <span id="progress-text-paru" style="font-weight: bold; font-size: 14px; color: #6c757d;">0%</span>
                    </div>
                    <div style="width: 150px; height: 8px; background: #e9ecef; border-radius: 4px; overflow: hidden;">
                        <div id="progress-bar-paru" style="width: 0%; height: 100%; transition: width 0.3s ease, background 0.3s ease;"></div>
                    </div>
                </div>
                <span id="progress-status-paru" style="font-size: 10px; color: #6c757d; white-space: nowrap;">(0/0)</span>
            </div>
        </div>
    ...
    <div class="form-card">
        <div class="form-content">
            <form id="formPenilaianMedisParu" method="post" action="">
                ...
                <div class="section">
                    ...
                    <div class="form-grid cols-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="status" 
                                   value="<?php echo $data['status']; ?>" placeholder="Status nutrisi pasien">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="section-subtitle" style="margin-top: 10px;">Status Pemeriksaan Organ</div>
                    ...
                    <div class="form-group" style="margin-top: 10px;">
                        <label>Keterangan Pemeriksaan Fisik Lainnya</label>
                        <textarea name="lainnya" rows="3" 
                                  placeholder="Jelaskan temuan pemeriksaan fisik lainnya / temuan abnormal..."><?php echo $data['lainnya']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="lokalis-wrapper">
                        <div class="lokalis-image">
                            <img src="<?= APP_BASE_URL ?>/images/paru.png" 
                                 alt="Gambar Lokalis Paru">
                            <p>Ilustrasi organ Paru</p>
                        </div>
                        <div class="form-group" style="flex: 1;">
                            <label>Keterangan</label>
                            <textarea name="ket_lokalis" rows="14" 
                                      placeholder="Jelaskan temuan pemeriksaan paru secara detail:&#10;- Inspeksi: bentuk dada, pergerakan dinding dada&#10;- Palpasi: fremitus taktil&#10;- Perkusi: sonor/hipersonor/redup&#10;- Auskultasi: vesikuler, rhonki, wheezing, dll"><?php echo $data['ket_lokalis']; ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-grid cols-3">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="pemeriksaan" rows="3" 
                                      placeholder="Spirometri, BTA, dll..."><?php echo $data['pemeriksaan']; ?></textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class="action-bar">
            <button type="button" class="btn btn-secondary" onclick="kembaliAwalMedisParu()">
            ...
            if($bolehHapus): 
            ?>
            <button type="button" id="btn-delete-paru" class="btn btn-danger" onclick="confirmDeleteParu()">
            ...
            <?php endif; ?>
            <button type="submit" id="btn-save-paru" form="formPenilaianMedisParu" class="btn btn-primary">
...
<script src="<?php echo BASE_URL; ?>/js/awalmedisparu.js?v=<?php echo time(); ?>"></script>
