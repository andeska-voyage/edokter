...
$queryCheck = bukaquery("SELECT pmr.*, d.nm_dokter as nama_dokter_pengisi
                         FROM penilaian_medis_ralan_orthopedi pmr
...
// Data default sesuai tabel penilaian_medis_ralan_orthopedi
$data = array(
...
<div class="modern-form-container">
            ...
            <div style="display:flex; align-items:center; gap:10px; background:#f8f9fa; border-radius:8px; padding:8px 12px;">
                ...
                <div style="display:flex; flex-direction:column; gap:2px;">
                    <div style="display:flex; align-items:center; gap:5px;">
                        ...
                        <span id="progress-text-ortho" style="font-weight:bold; font-size:14px; color:#6c757d;">0%</span>
                    </div>
                    <div style="width:150px; height:8px; background:#e9ecef; border-radius:4px; overflow:hidden;">
                        <div id="progress-bar-ortho" style="width:0%; height:100%; transition:width 0.3s ease, background 0.3s ease;"></div>
                    </div>
                </div>
                <span id="progress-status-ortho" style="font-size:10px; color:#6c757d; white-space:nowrap;">(0/0)</span>
            </div>
        </div>
    ...
    <div class="form-card">
        <div class="form-content">
            <form id="formPenilaianMedisOrtho" method="post" action="">
                ...
                <div class="section">
                    ...
                    <div class="form-grid cols-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="gcs"
                                   value="<?php echo htmlspecialchars($data['gcs']); ?>" placeholder="E4V5M6">
                        </div>
                    </div>

                    <!-- Baris 2: Tanda-Tanda Vital -->
                    ...
                    <div class="vital-grid">
                        ...
                        <div class="vital-item">
                            <label>Nyeri</label>
                            <input type="text" name="nyeri" value="<?php echo htmlspecialchars($data['nyeri']); ?>" placeholder="Skala / lokasi">
                        </div>
                    </div>

                    <!-- Baris 3: Status Organ + Lainnya -->
                    <div class="section-subtitle" style="margin-top:12px;">Status Pemeriksaan Organ</div>
                    ...
                    <div class="status-grid">
                                ...
                                <div class="status-item">
                                    ...
                                    <select name="columna">
                                        <option value="Normal"          <?php echo ($data['columna']=='Normal')         ?'selected':''; ?>>Normal</option>
                                        <option value="Abnormal"        <?php echo ($data['columna']=='Abnormal')       ?'selected':''; ?>>Abnormal</option>
                                        <option value="Tidak Diperiksa" <?php echo ($data['columna']=='Tidak Diperiksa')?'selected':''; ?>>Tidak Diperiksa</option>
                                    </select>
                                </div>
                                <div class="status-item">
                                    <label>Muskuloskeletal</label>
                                    <select name="muskulos">
                                        <option value="Normal"          <?php echo ($data['muskulos']=='Normal')         ?'selected':''; ?>>Normal</option>
                                        <option value="Abnormal"        <?php echo ($data['muskulos']=='Abnormal')       ?'selected':''; ?>>Abnormal</option>
                                        <option value="Tidak Diperiksa" <?php echo ($data['muskulos']=='Tidak Diperiksa')?'selected':''; ?>>Tidak Diperiksa</option>
                                    </select>
                                </div>
                                <div class="status-item">
                                    <label>Genetalia Os Pubis</label>
                                    <select name="genetalia">
                                        <option value="Normal"          <?php echo ($data['genetalia']=='Normal')         ?'selected':''; ?>>Normal</option>
                                        <option value="Abnormal"        <?php echo ($data['genetalia']=='Abnormal')       ?'selected':''; ?>>Abnormal</option>
                                        <option value="Tidak Diperiksa" <?php echo ($data['genetalia']=='Tidak Diperiksa')?'selected':''; ?>>Tidak Diperiksa</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <label>Lainnya (Keterangan Pemeriksaan Fisik jika ada Abnormal)</label>
                        <textarea name="lainnya" rows="2"
                                  placeholder="Jelaskan temuan abnormal..."><?php echo htmlspecialchars($data['lainnya']); ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="lokalis-wrapper">
                        <div class="lokalis-image">
                            <img src="<?php echo APP_BASE_URL; ?>/images/bedah.png"
                                 alt="Ilustrasi Tubuh Orthopedi">
                            <p>Ilustrasi Lokasi Status Lokalis</p>
                        </div>
                        <div class="form-group" style="flex:1;">
                            <label>Keterangan Status Lokalis</label>
                            <textarea name="ket_lokalis" rows="14"
                                      placeholder="Jelaskan temuan status lokalis secara detail:&#10;- Lokasi kelainan (sesuai nomor gambar)&#10;- Jenis kelainan: fraktur, dislokasi, dll&#10;- Range of motion, kekuatan otot&#10;- Pembengkakan, nyeri tekan, deformitas"><?php echo htmlspecialchars($data['ket_lokalis']); ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-grid cols-3">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="pemeriksaan" rows="4"
                                      placeholder="Hasil pemeriksaan penunjang lainnya..."><?php echo htmlspecialchars($data['pemeriksaan']); ?></textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class="action-bar">
            <button type="button" class="btn btn-secondary" onclick="kembaliAwalMedisOrtho()">
            ...
            if ($bolehHapus): ?>
            <button type="button" id="btn-delete-ortho" class="btn btn-danger" onclick="confirmDeleteOrtho()">
            ...
            <button type="submit" id="btn-save-ortho" form="formPenilaianMedisOrtho" class="btn btn-primary">
...
<script src="<?php echo BASE_URL; ?>/js/awalmedisorthopedi.js?v=<?php echo time(); ?>"></script>
