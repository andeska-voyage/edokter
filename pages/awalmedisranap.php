...
// Handle DELETE request - via AJAX di awalmedisranap.js (hapusData -> proses3.php)
...
// Cek apakah sudah ada data penilaian medis ranap dengan info dokter
...
// Cek apakah ada data IGD untuk tombol GET DATA IGD
$queryIGD = bukaquery("SELECT no_rawat FROM penilaian_medis_igd WHERE no_rawat = '$no_rawat' LIMIT 1");
$hasDataIGD = (mysqli_num_rows($queryIGD) > 0) ? true : false;
?>
...
/* Status grid 6 kolom untuk ranap (ada lebih banyak organ) */
.status-grid-ranap {
    display: grid;
...
<div class="modern-form-container">
    ...
    <div class="patient-header">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px; flex-wrap: wrap; gap: 10px;">
            ...
            <div style="display: flex; align-items: center; gap: 10px;">
                <?php if($hasDataIGD): ?>
                <button type="button" class="btn-get-igd" id="btn-get-igd" onclick="getDataIGD()" title="Ambil data dari Asesmen IGD">
                ...
                <div style="display: flex; align-items: center; gap: 10px; background: #f8f9fa; border-radius: 8px; padding: 8px 12px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 2px;">
                        <div style="display: flex; align-items: center; gap: 5px;">
                            ...
                            <span id="progress-text-ranap" style="font-weight: bold; font-size: 14px; color: #6c757d;">0%</span>
                        </div>
                        <div style="width: 150px; height: 8px; background: #e9ecef; border-radius: 4px; overflow: hidden;">
                            <div id="progress-bar-ranap" style="width: 0%; height: 100%; transition: width 0.3s ease, background 0.3s ease;"></div>
                        </div>
                    </div>
                    <span id="progress-status-ranap" style="font-size: 10px; color: #6c757d; white-space: nowrap;">(0/0)</span>
                </div>
            </div>
        </div>
        <div class="patient-info">
            ...
            <div class="info-item">
                ...
                <strong>Bangsal:</strong> <?php echo $rsPasien['nm_bangsal'] ?? '-'; ?>
            </div>
    ...
    <div class="form-card">
        <div class="form-content">
            <form id="formPenilaianMedisRanap" method="post" action="">
                ...
                <div class="section">
                    ...
                    <div class="form-grid cols-2" style="margin-top: 10px;">
                        <div class="form-group">
                            ...
                            <textarea name="keluhan_utama" rows="2" 
                    ...
                    <div class="form-grid cols-3">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="rad" rows="4" 
                                      placeholder="Hasil Rontgen, CT Scan, USG, dll..."><?php echo $data['rad']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Penunjang Lainnya (EKG, EEG, dll)</label>
        ...
        <div class="action-bar">
            <button type="button" class="btn btn-secondary" onclick="kembaliAwalMedisRanap()">
            ...
            <?php endif; ?>
            <button type="submit" id="btn-save-ranap" form="formPenilaianMedisRanap" class="btn btn-primary">
...
<!-- Delete via AJAX - handled by awalmedisranap.js -->

<script src="<?php echo BASE_URL; ?>/js/awalmedisranap.js?v=<?php echo time(); ?>"></script>
