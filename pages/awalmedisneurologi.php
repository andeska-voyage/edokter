...
// Cek data existing di tabel neurologi
$queryCheck = bukaquery("SELECT pmr.*, d.nm_dokter as nama_dokter_pengisi
                         FROM penilaian_medis_ralan_neurologi pmr
...
// Data default sesuai tabel penilaian_medis_ralan_neurologi
$data = array(
...
<div class="modern-form-container">
            ...
            <div style="display:flex; align-items:center; gap:10px; background:#f8f9fa; border-radius:8px; padding:8px 12px;">
                ...
                <div style="display:flex; flex-direction:column; gap:2px;">
                    <div style="display:flex; align-items:center; gap:5px;">
                        ...
                        <span id="progress-text-neuro" style="font-weight:bold; font-size:14px; color:#6c757d;">0%</span>
                    </div>
                    <div style="width:150px; height:8px; background:#e9ecef; border-radius:4px; overflow:hidden;">
                        <div id="progress-bar-neuro" style="width:0%; height:100%; transition:width 0.3s ease, background 0.3s ease;"></div>
                    </div>
                </div>
                <span id="progress-status-neuro" style="font-size:10px; color:#6c757d; white-space:nowrap;">(0/0)</span>
            </div>
        </div>
    ...
    <div class="form-card">
        <div class="form-content">
            <form id="formPenilaianMedisNeuro" method="post" action="">
                ...
                <div class="section">
                    ...
                    <!-- Baris 1: Kesadaran | Status Nutrisi | GCS -->
                    <div class="form-grid cols-3">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status">
                                <?php foreach ($enumStatus as $opt): ?>
                                <option value="<?php echo $opt; ?>" <?php echo ($data['status']==$opt)?'selected':''; ?>><?php echo htmlspecialchars($opt); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                ...
                <div class="section">
                    ...
                    <div style="display:flex; gap:16px; align-items:stretch;">
                        ...
                        <!-- Kolom kiri: 6 baris kelainan -->
                        <div style="flex:1; display:flex; flex-direction:column; gap:6px;">
                            <?php foreach ($statusKelainan as $sk):
                                $cv = $data[$sk[0]];
                                $sc = isset($statusColor[$cv]) ? $statusColor[$cv] : $statusColor['Normal'];
                            ?>
                            <div style="display:flex; align-items:center; background:#f8fafc; border:1px solid #e2e8f0; border-radius:6px; overflow:hidden;"
                                ...
                                <!-- Label + icon -->
                                <div style="display:flex; align-items:center; gap:5px; padding:0 10px; min-width:160px; background:linear-gradient(135deg,#667eea,#764ba2); color:white; align-self:stretch;">
                                    <i class="material-icons" style="font-size:13px; opacity:0.85;"><?php echo $sk[3]; ?></i>
                                ...
                                <div style="position:relative; flex-shrink:0;">
                                    <select name="<?php echo $sk[0]; ?>"
                                        ...
                                        <option value="<?php echo $opt; ?>" <?php echo ($cv==$opt)?'selected':''; ?>><?php echo $opt; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <span style="position:absolute; right:8px; top:50%; transform:translateY(-50%); pointer-events:none; color:<?php echo $sc['color']; ?>; font-size:13px;">▾</span>
                                </div>
                        ...
                        <div style="width:280px; flex-shrink:0; display:flex; flex-direction:column;">
                            ...
                            <textarea name="lainnya"
                                      style="flex:1; resize:none; border:1px solid #e2e8f0; border-top:none;
                                             ...
                                             background:white; outline:none; min-height:155px;"
        ...
        <div class="action-bar">
            <button type="button" class="btn btn-secondary" onclick="kembaliAwalMedisNeuro()">
            ...
            if ($bolehHapus): ?>
            <button type="button" id="btn-delete-neuro" class="btn btn-danger" onclick="confirmDeleteNeuro()">
            ...
            <button type="submit" id="btn-save-neuro" form="formPenilaianMedisNeuro" class="btn btn-primary">
...
<script src="<?php echo BASE_URL; ?>/js/awalmedisneurologi.js?v=<?php echo time(); ?>"></script>
