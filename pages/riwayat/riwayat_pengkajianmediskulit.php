...
// Query data pengkajian medis Kulit dan Kelamin (ralan)
$query_medis = "
    SELECT 
        p.*,
        d.nm_dokter
    FROM penilaian_medis_ralan_kulitdankelamin p
...
if (mysqli_num_rows($result_medis) == 0) {
    echo '<div class="alert alert-warning m-3">Data pengkajian medis Kulit dan Kelamin tidak ditemukan</div>';
    exit;
}
...
<div class="card mb-3 shadow-sm">    
    <div class="card-body">
        ...
        <div class="section-title">
            <i class="fa fa-allergies"></i> III. Status Dermatologis
        </div>
        <?php if (!empty($data['statusderma'])): ?>
        <div class="info-grid">
            <div class="info-item-vertical" style="grid-column: 1 / -1;">
                <span class="info-value"><?= nl2br(htmlspecialchars($data['statusderma'])) ?></span>
            </div>
        </div>
        <?php else: ?>
        <div class="info-grid">
        ...
        <!-- IV. STATUS LOKALIS -->
        <div class="section-title">
            <i class="fa fa-map-marker-alt"></i> IV. Status Lokalis
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="info-item-vertical">
                    <span class="info-label">Pemeriksaan:</span>
                ...
                <div class="info-item-vertical">
                    ...
                    <span class="info-value">
                        <img src="<?= APP_BASE_URL ?>/images/kulitkelamin.png" 
                            alt="Gambar Lokalis Kulit dan Kelamin" 
                            class="img-fluid" 
