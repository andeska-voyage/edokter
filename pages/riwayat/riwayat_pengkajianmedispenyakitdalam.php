...
// Query data pengkajian medis Penyakit Dalam (ralan)
$query_medis = "
    SELECT 
        p.*,
        d.nm_dokter
    FROM penilaian_medis_ralan_penyakit_dalam p
...
if (mysqli_num_rows($result_medis) == 0) {
    echo '<div class="alert alert-warning m-3">Data pengkajian medis Penyakit Dalam tidak ditemukan</div>';
    exit;
}
    ...
    <div class="card-body">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value"><?= htmlspecialchars($data['kondisi']) ?: '-' ?></span>
            </div>
            <div class="info-item">
        ...
        <div class="info-grid mt-2">
            <div class="info-item">
                ...
                <span class="info-value"><?= getBadgeStatus($data['kepala']) ?><?= !empty($data['keterangan_kepala']) ? ' &nbsp;<small style="color:#64748b;">' . htmlspecialchars($data['keterangan_kepala']) . '</small>' : '' ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Thoraks:</span>
                <span class="info-value"><?= getBadgeStatus($data['thoraks']) ?><?= !empty($data['keterangan_thorak']) ? ' &nbsp;<small style="color:#64748b;">' . htmlspecialchars($data['keterangan_thorak']) . '</small>' : '' ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Abdomen:</span>
                <span class="info-value"><?= getBadgeStatus($data['abdomen']) ?><?= !empty($data['keterangan_abdomen']) ? ' &nbsp;<small style="color:#64748b;">' . htmlspecialchars($data['keterangan_abdomen']) . '</small>' : '' ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Ekstremitas:</span>
                <span class="info-value"><?= getBadgeStatus($data['ekstremitas']) ?><?= !empty($data['keterangan_ekstremitas']) ? ' &nbsp;<small style="color:#64748b;">' . htmlspecialchars($data['keterangan_ekstremitas']) . '</small>' : '' ?></span>
            </div>
        </div>
