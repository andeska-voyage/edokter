...
// Query data pengkajian medis Bedah (ralan)
$query_medis = "
    SELECT 
        p.*,
        d.nm_dokter
    FROM penilaian_medis_ralan_bedah p
...
if (mysqli_num_rows($result_medis) == 0) {
    echo '<div class="alert alert-warning m-3">Data pengkajian medis Bedah tidak ditemukan</div>';
    exit;
}
            ...
            <div class="col-md-8">
                <div class="info-item-vertical">
                    ...
                    <span class="info-value">
                        <img src="<?= APP_BASE_URL ?>/images/bedah.png" 
                            alt="Gambar Lokalis Bedah" 
                            class="img-fluid" 
