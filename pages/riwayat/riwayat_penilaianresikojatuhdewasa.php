...
// Query untuk ambil data penilaian resiko jatuh dewasa
$query = "
    SELECT 
        prjd.tanggal,
        prjd.penilaian_jatuhmorse_skala1,
        prjd.penilaian_jatuhmorse_nilai1,
        prjd.penilaian_jatuhmorse_skala2,
        prjd.penilaian_jatuhmorse_nilai2,
        prjd.penilaian_jatuhmorse_skala3,
        prjd.penilaian_jatuhmorse_nilai3,
        prjd.penilaian_jatuhmorse_skala4,
        prjd.penilaian_jatuhmorse_nilai4,
        prjd.penilaian_jatuhmorse_skala5,
        prjd.penilaian_jatuhmorse_nilai5,
        prjd.penilaian_jatuhmorse_skala6,
        prjd.penilaian_jatuhmorse_nilai6,
        prjd.penilaian_jatuhmorse_totalnilai,
        prjd.hasil_skrining,
        prjd.saran,
        prjd.nip,
        p.nama AS nama_petugas
    FROM penilaian_lanjutan_resiko_jatuh_dewasa prjd
    LEFT JOIN petugas p ON prjd.nip = p.nip
    WHERE prjd.no_rawat = '$no_rawat'
    ORDER BY prjd.tanggal DESC
";

$result = bukaquery($query);

if (mysqli_num_rows($result) == 0) {
    echo '<div class="alert alert-warning m-3">Data penilaian resiko jatuh dewasa tidak ditemukan</div>';
    exit;
}
...
<div class="card-jatuh">
    <table class="tabel-jatuh">
        <tr>
            ...
            <!-- Kolom 2: Penilaian Morse Fall Scale -->
            <td class="col-penilaian">
                <div style="font-weight: bold; margin-bottom: 10px; color: #2c3e50;">Morse Fall Scale:</div>
                ...
                <div class="penilaian-item">
                    <span class="penilaian-label">4. Terapi Intravena</span>
