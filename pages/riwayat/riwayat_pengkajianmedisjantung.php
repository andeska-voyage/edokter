...
// Query data pengkajian medis Jantung (ralan)
$query_medis = "
    SELECT 
        p.*,
        d.nm_dokter
    FROM penilaian_medis_ralan_jantung p
...
if (mysqli_num_rows($result_medis) == 0) {
    echo '<div class="alert alert-warning m-3">Data pengkajian medis Jantung tidak ditemukan</div>';
    exit;
}
...
while ($data = mysqli_fetch_assoc($result_medis)):
    ...
    // Organ dengan keterangan inline — sesuai nama kolom di DB (typo ekstrimitas disengaja)
    $organs = [
        ['label' => 'Jantung',     'field' => 'jantung',     'ket' => 'keterangan_jantung'],
        ['label' => 'Paru',        'field' => 'paru',        'ket' => 'keterangan_paru'],
        ['label' => 'Ekstremitas', 'field' => 'ekstrimitas', 'ket' => 'keterangan_ekstrimitas'],
    ];
?>
<!-- Load CSS Template -->
...
<div class="card mb-3 shadow-sm">
    <div class="card-body">
        ...
        <!-- Pemeriksaan Organ Khusus Jantung -->
        ...
        <div class="info-grid">
            ...
            <div class="info-item-vertical">
                ...
                <span class="info-value"><?= nl2br(htmlspecialchars($data['penunjang_lain'])) ?: '-' ?></span>
            </div>
        </div>
