...
// Query data penilaian medis ranap
$query_medis = "
    SELECT 
        p.*,
        d.nm_dokter
...
if (mysqli_num_rows($result_medis) == 0) {
    echo '<div class="alert alert-warning m-3">Data penilaian medis rawat inap tidak ditemukan</div>';
    exit;
}
...
<div class="info-grid">
    ...
    <div class="info-item">
        ...
        <span class="info-value"><?= htmlspecialchars($data['td']) ? htmlspecialchars($data['td']) . ' mmHg' : '-' ?></span>
    </div>
    <div class="info-item">
        <span class="info-label">Nadi:</span>
        <span class="info-value"><?= htmlspecialchars($data['nadi']) ? htmlspecialchars($data['nadi']) . ' x/menit' : '-' ?></span>
    </div>
    <div class="info-item">
        <span class="info-label">RR:</span>
        <span class="info-value"><?= htmlspecialchars($data['rr']) ? htmlspecialchars($data['rr']) . ' x/menit' : '-' ?></span>
    </div>
    <div class="info-item">
        <span class="info-label">Suhu:</span>
        <span class="info-value"><?= htmlspecialchars($data['suhu']) ? htmlspecialchars($data['suhu']) . ' °C' : '-' ?></span>
    </div>
    <div class="info-item">
        <span class="info-label">SpO2:</span>
        <span class="info-value"><?= htmlspecialchars($data['spo']) ? htmlspecialchars($data['spo']) . ' %' : '-' ?></span>
    </div>
    <div class="info-item">
        <span class="info-label">BB:</span>
        <span class="info-value"><?= htmlspecialchars($data['bb']) ? htmlspecialchars($data['bb']) . ' kg' : '-' ?></span>
    </div>
    <div class="info-item">
        <span class="info-label">TB:</span>
        <span class="info-value"><?= htmlspecialchars($data['tb']) ? htmlspecialchars($data['tb']) . ' cm' : '-' ?></span>
    </div>
</div>

<!-- Baris 2: Kepala sampai Genital -->
<div class="info-grid mt-2">
    ...
    <div class="info-item">
        <span class="info-label">Gigi & Mulut:</span>
    ...
    <div class="info-item">
        <span class="info-label">Jantung:</span>
        <span class="info-value"><?= getBadgeStatus($data['jantung']) ?></span>
    </div>
    <div class="info-item">
        <span class="info-label">Paru:</span>
        <span class="info-value"><?= getBadgeStatus($data['paru']) ?></span>
    </div>
    <div class="info-item">
...
<!-- Baris 3: Keterangan Fisik (jika ada) -->
