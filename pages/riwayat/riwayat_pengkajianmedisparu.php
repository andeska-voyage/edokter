...
// Query data pengkajian medis Paru (ralan)
$query_medis = "
    SELECT 
        p.*,
        d.nm_dokter
    FROM penilaian_medis_ralan_paru p
...
if (mysqli_num_rows($result_medis) == 0) {
    echo '<div class="alert alert-warning m-3">Data pengkajian medis Paru tidak ditemukan</div>';
    exit;
}
