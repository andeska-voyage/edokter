...
// Ambil data pasien dari kamar_inap / reg_periksa
...
// Cek data existing di tabel ranap
$queryCheck = bukaquery("SELECT pmr.*, d.nm_dokter as nama_dokter_pengisi
                         FROM penilaian_medis_ranap_jantung pmr
...
// Data default sesuai tabel penilaian_medis_ranap_jantung
$data = array(
...
function renderOrganRowJantungInap($field, $ketField, $label, $icon, $data, $enumOrgan, $statusColor) {
...
<div class="modern-form-container">
    ...
    <div class="patient-header">
        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:8px;">
            <h1 style="margin:0; display:flex; align-items:center; gap:10px;">
                ...
                PENILAIAN AWAL MEDIS RAWAT INAP JANTUNG
                <?php if ($isEdit): ?>
            ...
            <div style="display:flex; align-items:center; gap:10px; background:#f8f9fa; border-radius:8px; padding:8px 12px;">
                ...
                <div style="display:flex; flex-direction:column; gap:2px;">
                    <div style="display:flex; align-items:center; gap:5px;">
                        ...
                        <span id="progress-text-jantunginap" style="font-weight:bold; font-size:14px; color:#6c757d;">0%</span>
                    </div>
                    <div style="width:150px; height:8px; background:#e9ecef; border-radius:4px; overflow:hidden;">
                        <div id="progress-bar-jantunginap" style="width:0%; height:100%; transition:width 0.3s ease, background 0.3s ease;"></div>
                    </div>
                </div>
                <span id="progress-status-jantunginap" style="font-size:10px; color:#6c757d; white-space:nowrap;">(0/0)</span>
            </div>
        </div>
    ...
    <div class="form-card">
        <div class="form-content">
            <form id="formPenilaianMedisJantungInap" method="post" action="">
                ...
                <div class="section">
                    ...
                    <!-- Keadaan Umum | Nyeri | Status Nutrisi -->
                ...
                <div class="section">
                    ...
                    <div style="display:flex; gap:16px; align-items:stretch;">
                        ...
                        <div style="flex:1; display:flex; flex-direction:column; gap:0;">
                            <?php
                            renderOrganRowJantungInap('jantung',    'keterangan_jantung',    'Jantung',    'favorite', $data, $enumOrgan, $statusColor);
                            renderOrganRowJantungInap('paru',       'keterangan_paru',       'Paru',       'air',      $data, $enumOrgan, $statusColor);
                            renderOrganRowJantungInap('ekstrimitas','keterangan_ekstrimitas','Ekstremitas','pan_tool', $data, $enumOrgan, $statusColor);
                            ?>
                        </div>
        ...
        <div class="action-bar">
            <button type="button" class="btn btn-secondary" onclick="kembaliAwalMedisJantungInap()">
            ...
            if ($bolehHapus): ?>
            <button type="button" id="btn-delete-jantunginap" class="btn btn-danger" onclick="confirmDeleteJantungInap()">
            ...
            <button type="submit" id="btn-save-jantunginap" form="formPenilaianMedisJantungInap" class="btn btn-primary">
...
<script src="<?php echo BASE_URL; ?>/js/awalmedisjantunginap.js?v=<?php echo time(); ?>"></script>
